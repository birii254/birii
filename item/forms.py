...
class NewItemForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Set up condition choices
        self.fields['condition'].choices = [('', 'Select condition')] + list(Item.CONDITION_CHOICES)
        ...
        if not categories.exists():
            try:
                ...
                # If command fails, at least show any existing categories
...
class EditItemForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Set up choices for condition and status
        self.fields['condition'].choices = [('', 'Select condition')] + list(Item.CONDITION_CHOICES)
        self.fields['status'].choices = [('', 'Select status')] + list(Item.STATUS_CHOICES)
